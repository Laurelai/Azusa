...
sub write {
	...
	open(my $fh, '>', $file) or return((0, 'Unable to open '.$file.' for writing: '.$!));

	print $fh <<EOF;
# This file has been automatically generated by Azusa::Configuration [$0]
# Please do not edit this file unless you are sure it won't be overwritten.
